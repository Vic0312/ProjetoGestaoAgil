            ...
            <section class="area-cadastro" id="cadastro" aria-labelledby="titulo-cadastro">
                <div class="cartao-cadastro">
                    ...
                    <div class="seletor-perfil" role="group" aria-label="Tipo de perfil">
                        <button class="opcao-perfil ativa" type="button" aria-pressed="true">
                            <svg viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <button class="opcao-perfil" type="button" aria-pressed="false">
                            <svg viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <form class="formulario-cadastro">
                        <label class="campo-formulario">
                            ...
                            <span class="controle-campo">
                                ...
                                <input type="text" name="nome" placeholder="Digite seu nome" autocomplete="name">
                            </span>
                        </label>
                        ...
                        <label class="campo-formulario">
                            ...
                            <span class="controle-campo">
                                ...
                                <input type="password" name="senha" placeholder="Crie uma senha" autocomplete="new-password">
                            </span>
                        </label>
                        ...
                        <label class="campo-formulario">
                            ...
                            <span class="controle-campo">
                                ...
                                <input type="password" name="confirmarSenha" placeholder="Repita sua senha" autocomplete="new-password">
                            </span>
                        </label>
                        ...
                        <a class="botao botao-principal botao-cadastro" href="dashboardPaciente.php">Criar conta</a>
                    </form>
